...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Dropdown(config)
            ...
            -- Ajuste no UICorner para garantir que o arredondamento seja visível
            local DropFrameCorner = Linux.Instance("UICorner", {
                Parent = DropFrame,
                CornerRadius = UDim.new(0, 6) -- Aumentado para 6 pixels para maior visibilidade
            })

            -- Ajuste nas bordas para seguir o arredondamento
        ...
        function TabElements.Input(config)
            ...
            local TextBox = Linux.Instance("TextBox", {
                Parent = Input,
                BackgroundColor3 = Linux.Theme.Toggle,
                Size = UDim2.new(0.3, -10, 0, 24), -- Reduzido de 0.5 para 0.3 (30% da largura)
                Position = UDim2.new(0.7, 5, 0.5, -12), -- Ajustado para manter alinhamento à direita
                Font = Enum.Font.SourceSans,
